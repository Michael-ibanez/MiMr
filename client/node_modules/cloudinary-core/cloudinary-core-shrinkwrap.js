...
__webpack_require__.d(lodash_namespaceObject, "isElement", function() { return isElement; });
__webpack_require__.d(lodash_namespaceObject, "isFunction", function() { return isFunction; });
__webpack_require__.d(lodash_namespaceObject, "trim", function() { return trim; });
...
var lodash_addClass = function addClass(element, name) {
  if (!element.className.match(new RegExp("\\b".concat(name, "\\b")))) {
    return element.className = trim("".concat(element.className, " ").concat(name));
  }
      ...
      if (isEmpty(this.value())) {
        ...
        return this.value().map(function (t) {
          if (isString_default()(t) && !isEmpty(t)) {
            ...
            return t.serialize();
          } else if (isPlainObject_default()(t) && !isEmpty(t)) {
...
function () {
  ...
  function TransformationBase(options) {
    ...
    this.rawParam = function (value, name, abbr, defaultValue) {
      var process = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : identity_default.a;
    ...
    this.arrayParam = function (value, name, abbr) {
      ...
      var process = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : identity_default.a;
      process = lastArgCallback(arguments);
  ...
  transformation_createClass(TransformationBase, [{
    ...
    value: function toHtmlAttributes() {
      ...
      for (key in this.otherOptions) {
        ...
        if (includes_default()(transformation_Transformation.PARAM_NAMES, snakeCase(key))) {
          continue;
        }
  ...
  transformation_createClass(Transformation, [{
    ...
    */
    ...
    value: function offset(value) {
      ...
      var _ref = isFunction(value != null ? value.split : void 0) ? value.split('..') : isArray_default()(value) ? value : [null, null];
...
function url_url(publicId) {
  ...
  return url || compact_default()([prefix, resourceTypeAndType, transformationString, version, publicId]).join('/').replace(/([^:])\/+/g, '$1/');
}
;
...
function (_HtmlTag) {
  ...
  function ClientHintsMetaTag(options) {
    ...
    return clienthintsmetatag_possibleConstructorReturn(this, clienthintsmetatag_getPrototypeOf(ClientHintsMetaTag).call(this, 'meta', void 0, assign_default()({
  ...
  cloudinary_createClass(Cloudinary, [{
    ...
    */
    ...
    value: function cloudinary_update(elements, options) {
      ...
      elements = function () {
        switch (false) {
          case !isArray_default()(elements):
            return elements;

          case elements.constructor.name !== "NodeList":
            return elements;

          case !isString_default()(elements):
